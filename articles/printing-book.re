 ...
 * 振込額はいくらか？
   * 22,740円に送料が必要だと思うが大きさや重量がわからず振込総額がわからない。
 * データはあれで大丈夫か？
 ...
 * 表紙4（裏表紙）の右下のサークル名のフォントが埋込になっていないがこのまま印刷してよいか
 * 本文にカラー画像あるけどどうするか 本文フルカラーは入稿期限終わっちゃったんですよ
   * なんか口ぶり的には別のオプションだとまだ間に合うっぽかったけどそこは求めてないのであまりよく確認せず
 * 見積もりはメールで送る
 ...
 * 本文はそちらでグレースケールに変換してほしい
   ...
   * じゃあとりあえずオペレーターさんにデータ送ってどう出力されるか聞いてみるぽん
...
念のため本文PDFのリンク系の枠線を消す方法を調べておいた@<fn>{nolinks-mod}。
